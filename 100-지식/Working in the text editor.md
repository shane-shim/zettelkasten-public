...
![image]()
1. **Which shortcut actions can I take in the text editor?**
- Headings (H1, H2, H3, H4, H5, H6)
...
- Underline (⌘-U) (Ctrl-U)
    - You can select a part of the text and click the underline button in the toolbar to make the selected text underlined or remove the underline style if the text is already underlined.
...
- External Link
    - You can select a part of the text and click the external link button to add an external link.
...
1. **What are the embed/upload options for the text editor?**
...
**Learn more:**
<< Working with Boards and the Desk               Importing and exporting Docs >>

## 🔗 연결된 카드
- [Working with Boards and the Desk](Working%20with%20Boards%20and%20the%20Desk.md)
- [Importing and exporting Docs](Importing%20and%20exporting%20Docs.md)
